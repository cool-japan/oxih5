...
- [ ] Profile memory allocation for large dataset reads — Use cargo bench with --profile release + heaptrack/DHAT externally; criterion benchmarks in benches/ provide timing baseline.
